                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-9115c8e8f37e6ae8e8a8fd3cbb73708bd1c9650d16155e7cd6a3825b438998b2">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            href="/ec-council/certifications"
                                                                            hreflang="en">EC-Council Certifications</a>
                                                                    </h3>
                                                                </div>
                                                                            ...
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="168"
                                                                                        role="article"
                                                                                        about="/ec-council/ceh"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>

                                                                                            <h4 class="node__title">
                                                                                                <a href="/ec-council/ceh"
                                                                                                    rel="bookmark"><span
                                                                                                        class="field field--name-title field--type-string field--label-hidden">CEH
                                                                                                        certification</span>
                                                                                                </a>
                                                                                            </h4>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="field__item">
                                                                                                    <p><strong>312-50</strong>�&nbsp;Certified
                                                                                                        Ethical Hacker
                                                                                                        (CEH)</p>
                                                                                                </div>
                                                                                            </div>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="169"
                                                                                        role="article"
                                                                                        about="/ec-council/cciso"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>

                                                                                            <h4 class="node__title">
                                                                                                <a href="/ec-council/cciso"
                                                                                                    rel="bookmark"><span
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="170"
                                                                                        role="article"
                                                                                        about="/ec-council/chfi"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>

                                                                                            <h4 class="node__title">
                                                                                                <a href="/ec-council/chfi"
                                                                                                    rel="bookmark"><span
                                                                                                        class="field field--name-title field--type-string field--label-hidden">Computer
                                                                                                        Hacking Forensic
                                                                                                        Investigator
                                                                                                        (CHFI)</span>
                                                                                                </a>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="175"
                                                                                        role="article"
                                                                                        about="/ec-council/eces"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
