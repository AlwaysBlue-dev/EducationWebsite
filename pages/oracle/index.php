...
<title>All Exams Done – Oracle Certification Program</title>
                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-3e45abaf99d08dbf441cda55cfa18c1cfe60b0916e6afef48f3a85c9ee1a26d2">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a href="/oracle/database"
                                                                            hreflang="en" id="chatLink">Oracle
                                                                            Database</a></h3>
                                                                </div>
                                                                            ...
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="295"
                                                                                        role="article"
                                                                                        about="/oracle/database-12c-administrator-associate"
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="296"
                                                                                        role="article"
                                                                                        about="/oracle/database-12c-administrator-professional"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="297"
                                                                                        role="article"
                                                                                        about="/oracle/database-administration-2019-professional"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            ...
                                                                            hreflang="en" id="chatLink">Oracle Java and
                                                                            Dev Tech
                                                                            Certification</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
                                                                            ...
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="299"
                                                                                        role="article"
                                                                                        about="/oracle/associate-java-se-8-programmer"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="300"
                                                                                        role="article"
                                                                                        about="/oracle/professional-java-se-8-programmer"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="301"
                                                                                        role="article"
                                                                                        about="/oracle/professional-java-se-11-developer"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="field__item">
                                                                                                    <p><strong>1Z0-815</strong>
                                                                                                        Java SE 11
                                                                                                        Programmer I</p>

                                                                                                    <p><strong>1Z0-816</strong>
                                                                                                        Java SE 11
                                                                                                        Programmer II
                                                                                                    </p>
