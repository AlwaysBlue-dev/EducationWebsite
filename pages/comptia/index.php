...
<title>Pro Exam Takers – CompTIA</title>
                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-14a9507f6a4bf222baab4dc53283bf31d2906da192b980b379a85ecef4df5706">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            ...
                                                                            hreflang="en" id="chatLink">CompTIA
                                                                            INFRASTRUCTURE
                                                                            Certifications</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
                                                                        ...
                                                                        <div class="item-list">
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="150"
                                                                                        role="article"
                                                                                        about="/comptia/server-plus"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                        ...
                                                                        <div class="item-list">
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="158"
                                                                                        role="article"
                                                                                        about="/comptia/project-plus"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="159"
                                                                                        role="article"
                                                                                        about="/comptia/cloud-essentials"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
