...
<title>All Exams Done – AWS Certification Program</title>
                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-17052d87ee79091ac841a32f4e0cd5fe3be905f6680b5720afcfd73d03c7e934">
                                                        ...
                                                        <div class="view-content">
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a href="#" hreflang="en"
                                                                            id="chatLink">AWS
                                                                            Foundational</a></h3>
                                                                </div>
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a href="#" hreflang="en"
                                                                            id="chatLink">AWS Associate</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
                                                                    <div class="field-content">
                                                                        <div class="item-list">
                                                                            <ul class="list-group">
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="199"
                                                                                        role="article"
                                                                                        about="/aws/developer-associate"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            href="/aws/professional" hreflang="en"
                                                                            id="chatLink">AWS
                                                                            Professional</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
                                                                            ...
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="202"
                                                                                        role="article"
                                                                                        about="/aws/solutions-architect-professional"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                            ...
                                                                            <ul class="list-group">
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="206"
                                                                                        role="article"
                                                                                        about="/aws/data-analytics-specialty"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="207"
                                                                                        role="article"
                                                                                        about="/aws/advanced-networking-specialty"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="208"
                                                                                        role="article"
                                                                                        about="/aws/machine-learning-specialty"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="209"
                                                                                        role="article"
                                                                                        about="/aws/alexa-skill-builder-specialty"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
