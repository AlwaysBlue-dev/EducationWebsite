...
<title>All Exams Done – Prince2 Certification Program</title>
                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-6eb8e88ff11310c3a0436b3375199e6da6d6a4e272cb3caf965ffc0c8e86505f">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            href="/prince2/certifications" hreflang="en"
                                                                            id="chatLink">PRINCE2 Certification
                                                                            levels</a></h3>
                                                                </div>
                                                                        ...
                                                                        <div class="item-list">
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="237"
                                                                                        role="article"
                                                                                        about="/prince2/prince2-foundation"
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="238"
                                                                                        role="article"
                                                                                        about="/prince2/prince2-practitioner"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="240"
                                                                                        role="article"
                                                                                        about="/prince2/prince2-agile-practitioner"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
