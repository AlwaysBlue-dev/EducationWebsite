...
<title>All Exams Done – Six-Sigma Certification Program</title>
                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-4b5386a00dc435ddfdccea6a44905d8114b24bd5348746fa483fa6fbd31efb12">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            ...
                                                                            hreflang="en" id="chatLink">Six Sigma
                                                                            Certification
                                                                            levels</a></h3>
                                                                </div>
                                                                        ...
                                                                        <div class="item-list">
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="222"
                                                                                        role="article"
                                                                                        about="/six-sigma/yellow-belt"
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="223"
                                                                                        role="article"
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="224"
                                                                                        role="article"
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="225"
                                                                                        role="article"
                                                                                        about="/six-sigma/master-black-belt"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>
