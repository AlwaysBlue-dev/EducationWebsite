                                    ...
                                    <div class="block-region-top">
                                        <div
                                            ...
                                            <div class="content">
                                                <div>
                                                    <div
                                                        class="view-with-margin view view-certification-programs view-id-certification_programs view-display-id-block_1 js-view-dom-id-f2b1176c96406e8e35e1e43fc1a6949cfb32ee447862305c25d107539f2ea42d">
                                                        ...
                                                        <div class="view-content">
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a href="/itil/foundation"
                                                                            hreflang="en" id="chatLink">ITIL Foundation</a></h3>
                                                                </div>
                                                                            ...
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="228"
                                                                                        role="article"
                                                                                        about="/itil/itil-4-foundation"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>

                                                                                            <h4 class="node__title">
                                                                                                <a href="/itil/itil-4-foundation"
                                                                                                    rel="bookmark"><span
                                                                                                        class="field field--name-title field--type-string field--label-hidden" id="chatLink">ITIL
                                                                                                        4
                                                                                                        Foundation</span>
                                                                                                </a>
                                                                                            </h4>
                                                                                ...
                                                                                <li class="list-group-item">
                                                                                    ...
                                                                                    <article data-history-node-id="227"
                                                                                        role="article"
                                                                                        about="/itil/v3-foundation"
                                                                                        class="node node--type-exam node--promoted node--view-mode-exam-certification-page clearfix">
                                                                                        <header>

                                                                                            <h4 class="node__title">
                                                                                                <a href="/itil/v3-foundation"
                                                                                                    rel="bookmark"><span
                                                                                                        class="field field--name-title field--type-string field--label-hidden" id="chatLink">ITIL
                                                                                                        v3
                                                                                                        Foundation</span>
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a
                                                                            href="/itil/intermediate" hreflang="en" id="chatLink">ITIL
                                                                            Intermediate</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
                                                                    <div class="field-content">
                                                            ...
                                                            <div class="row-inner views-row">
                                                                <div class="views-field views-field-title">
                                                                    <h3 class="field-content"><a href="/itil/advanced"
                                                                            hreflang="en" id="chatLink">ITIL Advanced</a></h3>
                                                                </div>
                                                                <div class="views-field views-field-field-exam">
